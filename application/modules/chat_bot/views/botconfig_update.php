            ...
            <div class="card-body">
                <form action="" method="post" class="validatform formssample" id="course" novalidate="" enctype="multipart/form-data">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control healthcategorysub" name="healthcategorysub" required="">
                                    ...
                                    if(is_array($vi) && count($vi) > 0){
                                        foreach($vi as $ver){
                                            $cl     =   ($view['symptoms_sub_health'] == $ver['id'])?"selected=selected":"";
                                            echo '<option value="'.$ver["id"].'" '.$cl.'>'.$ver["text"].'</option>';
                                        }
                                    }
                                    ?>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Auto Bot <span class="required text-danger">*</span></label> 
                                <input type="checkbox" <?php echo ($view['symptoms_auto_start'] == 1)?"checked=checked":"";?> name="symptoms_auto_start" value="1"/>
                                <?php echo form_error('symptoms_auto_start');?> 
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Order" required="" name="symptoms_order" value="<?php echo (is_array($view) && count($view) > 0)?$view['symptoms_order']:set_value('symptoms_order');?>"/>
                                <?php echo form_error('symptoms_order');?> 
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Question  <span class="required text-danger">*</span></label> 
                                <textarea class="form-control" placeholder="Question" required="" name="botauto_question"><?php echo (isset($view) && is_array($view) && count($view) > 0)?$view["symptoms_question"]:set_value('botauto_question');?></textarea>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Options</label>
                                <div>
                                    <input name="botauto_tags" type="text"  data-role="tagsinput" class="form-control text-capitalize" placeholder="Options" value="<?php echo (is_array($view) && count($view) > 0)?$view['symptoms_options']:set_value('botauto_tags');?>" required=""/>
                                </div>
