                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="module" required onchange="getCategory()" id="module">
                                    ...
                                    <?php foreach($module as $m){ ?>
                                     <?php if($m['moduleid']==set_value("module")){?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                            <div class="form-group">
                                ...
                                <input name="sub_category_name" type="text" class="form-control" placeholder="Enter Sub Category" required="" autocomplete="off" value="<?php echo set_value("sub_category_name");?>"/>
                                <input type="hidden" id="cci" value="<?php echo set_value("category");?>">
