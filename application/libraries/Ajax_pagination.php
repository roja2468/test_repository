...
class Ajax_pagination{
    ...
    var $next_link			= '&rsaquo;&rsaquo;';
    var $prev_link			= '&lsaquo; &lsaquo; ';
    var $last_link			= '&rsaquo;';
    var $uri_segment		= 3;
    var $full_tag_open		= '<nav class="mt-xl" aria-label="Page navigation example">';
    ...
    var $new_tag_open		= '<div class="float-left">';    
    var $new_tag_close		= '</div>';    
    var $page_tag_open		= '<div class="float-right"><ul class="pagination pagination-basic pagination-circle">';    
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<div class="mt-lg">Showing : ' . $this->total_rows."</div>";
            return $info.'<script>tootTip();</script>';
        }
        ...
        <?php
        return $output.'<script>tootTip();</script>';
    }
